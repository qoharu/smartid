<html>
    ...
    ?>
        ...
        <link href="<?php echo base_url('assets/css/font-awesome-eyes.css'); ?>" rel="stylesheet">
    ...
    <body class="white">
        ...
        <script src="<?php echo base_url('assets/js/jquery.prevue.min.js'); ?>"></script>
        <script>
            ...
            <div class="navbar-collapse collapse navbar-responsive-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li <?php if (current_url() == site_url('admin')) echo "class='active'"; ?>>
                        <a href="<?php echo site_url('adminarea'); ?>"><strong>Admin Area</strong></a>
                    </li>    
                    <?php endif ?>
                </ul>
